...
type ProductData struct {
	...
	NormalPrice                   types.FlexibleFloat64 `json:"normal_price,omitempty"`
	CurrentPrice                  types.FlexibleFloat64 `json:"current_price,omitempty"`
	Pc30Price                     types.FlexibleFloat64 `json:"pc30_price,omitempty"`
	PricePerUnit                  types.FlexibleFloat64 `json:"price_per_unit,omitempty"`
